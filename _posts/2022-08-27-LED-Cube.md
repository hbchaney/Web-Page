...
({{site.baseurl}}/_posts/Schematic.png)
...
- solder wires directly to the microcontroller  
	This is the easist permanent method. The downside to this method is you cannot test your cube via breadboard before soldering everything together. PLEASE DOUBLE CHECK THE DIAGRAM. Before soldering ![Cube]({{site.baseurl}}/_posts/Schematic.png)
